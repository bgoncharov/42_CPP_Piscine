...
/*   Updated: 2019/10/25 15:25:22 by bogoncha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string type) : _hitPoints(hitPoints), _maxHitPoints(maxHitPoints),
 ...
 _rangedAttackDamage(rangedAttackDamage), _coltAttackDamage(coltAttackDamage), 
 _rockAttackDamage(rockAttackDamage), _gunAttackDamage(gunAttackDamage),
 _boboAttackDamage(boboAttackDamage), _ticklesAttackDamage(ticklesAttackDamage),
